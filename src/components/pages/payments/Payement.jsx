...
function Payments() {
    ...
    const handleReadDonors = () => {
        axios.get(`http://localhost:3000/peyment/?page=${page}`).then((res) => {
    ...
    const handleDeleteDonor = (id) => {
        axios.delete(`http://localhost:3000/peyment/${id}`).then((res) => {
                        ...
                        return <tbody className="border-b border-thirdColor">
                            <tr className="text-textColor text-center">
                               ...
                               <td className="py-4">{data.id}</td>
                                ...
                                {/* <td className="py-4">
                           <Link to={`/patient/${data.id}`} className="text-primeryColor bg-green-500 p-1 rounded-sm">Payment</Link>
                                 </td> */}
